...
function TestimonialCard({
  ...
  return (
    <article
      ...
      className={`flex flex-col rounded-3xl border border-brand-dark/10 bg-brand-paper p-6 sm:p-7 ${
    ...
    >
      ...
      <footer className="mt-6 flex items-center gap-4 border-t border-brand-dark/12 pt-5">
        <span
          aria-hidden="true"
