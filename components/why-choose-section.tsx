      ...
      <div className="container mx-auto max-w-6xl px-4 md:px-8">
        <div className="grid gap-8 lg:grid-cols-[minmax(0,4fr)_minmax(0,8fr)] lg:items-start lg:gap-12 xl:gap-16">
          <div className="max-w-xl lg:pt-2">
            ...
            <h2 className="mt-4 text-3xl font-bold leading-tight tracking-tight text-brand-dark sm:text-4xl">
              Mengapa Memilih NUSA?
            </h2>
            <p className="mt-5 max-w-lg text-base leading-relaxed text-brand-dark/80 sm:text-lg">
