...
export function FAQSection() {
  return (
    ...
    >
      <div className="mx-auto grid max-w-6xl gap-8 md:grid-cols-[0.8fr_1.2fr] md:gap-12">
        <div className="md:sticky md:top-24 md:self-start">
          <div className="mb-4 inline-flex size-11 items-center justify-center rounded-2xl bg-brand-highlight/15 text-brand-depth">
        ...
        >
          {FAQ_ITEMS.map(
            ({ id, question, answer, sourceLabel, sourceUrl }) => (
              ...
              >
                <AccordionTrigger className="py-4 text-base font-semibold leading-6 text-brand-dark transition-colors duration-150 hover:text-brand hover:no-underline focus-visible:ring-brand/40 [&>svg]:transition-transform [&>svg]:duration-150">
                  {question}
                </AccordionTrigger>
                <AccordionContent className="max-w-2xl pb-4 pr-8 text-[15px] leading-7 text-brand-dark/[0.72]">
                  <p>
                    {answer}{" "}
